...
#line 1669 "./syntax.tab.c"
  ...
  case 11:
#line 44 "./syntax.y"
                   {(yyval.type_node)=addNode("ExtDecList",1,(yyvsp[0].type_node));}
#line 1675 "./syntax.tab.c"
    break;

  case 12:
#line 45 "./syntax.y"
                           {(yyval.type_node)=addNode("ExtDecList",3,(yyvsp[-2].type_node),(yyvsp[-1].type_node),(yyvsp[0].type_node));}
#line 1681 "./syntax.tab.c"
    break;

  case 13:
#line 48 "./syntax.y"
                {(yyval.type_node)=addNode("Specifier",1,(yyvsp[0].type_node));}
...
#line 1723 "./syntax.tab.c"
  ...
  case 20:
#line 60 "./syntax.y"
            {(yyval.type_node)=addNode("VarDec",1,(yyvsp[0].type_node));}
...
#line 1927 "./syntax.tab.c"
  ...
  case 54:
#line 104 "./syntax.y"
                     {(yyval.type_node)=addNode("DecList",3,(yyvsp[-2].type_node),(yyvsp[-1].type_node),(yyvsp[0].type_node));}
